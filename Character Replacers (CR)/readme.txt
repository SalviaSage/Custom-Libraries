...
The program automatically replaces that with (ế), latin small letter e with circumflex and acute (U+1EBF).
This for example, causes a decrease in filesize by one byte.
