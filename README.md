...
What they do is, they are "helper" files that are supposed to be used alongside the keyboard layout programs that I make as well as independent libraries that can be used on their own.
